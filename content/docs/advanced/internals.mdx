...
| Operations | `methods.ts` | Top-level imperative functions: `addComponent`, `getComponent`, `getComponents`, `setActive`, `getIsActive`, `getIsActiveSelf`, `destroy`, plus re-export of `attachContext`. All delegate into `Object3DExtension`. |
...
├── Object3DBehaviour.ts      base class for components
